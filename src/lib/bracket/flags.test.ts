...
const flagsSource = readFileSync(fileURLToPath(new URL('./flags.ts', import.meta.url)), 'utf8');
...
describe('flag assets', () => {
  ...
  // The team `import.meta.glob` in flags.ts must enumerate flag codes as a
